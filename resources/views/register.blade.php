<x-form-auth pageTitle="Register">
    <form action="{{ route('register') }}" method="POST">
        ...
        <input type="text" name="name" id="name" required="true" class="w-full px-3 py-2 bg-dark-100 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white">
        </div>
        <div class="mb-6">
        <label for="email" class="block text-gray-200 mb-2">Email</label>
        <input type="text" name="email" id="email" required="true" class="w-full px-3 py-2 bg-dark-100 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white">
        </div>
        <div class="mb-6">
